...
main_camera = naivert.Camera(Point(400,-300,400),Point(385,-285,385),10 * Vector(-1 /sqrt(6),1/sqrt(6),2/sqrt(6)),10*Vector(1/sqrt(2),1/sqrt(2),0),'main_camera.png',resolution=(400,400))
...
c1 = Point(76,43,80)
d1 = Point(38,9,80)
cpg1 = ConvexPolygen((a,b,c,d))
cpg2 = ConvexPolygen((a1,b1,c1,d1))
cpg3 = ConvexPolygen((a,b,b1,a1))
cpg4 = ConvexPolygen((b,c,c1,b1))
cpg5 = ConvexPolygen((c,d,d1,c1))
cpg6 = ConvexPolygen((d,a,a1,d1))
