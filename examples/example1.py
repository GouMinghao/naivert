...
main_camera = naivert.Camera(Point(50,-50,50),Point(50,0,50),Vector(0,0,25),Vector(25,0,0),'main_camera.png')
...
main_scene.add_cph(Parallelepiped(Point(25,25,0),10*x_unit_vector(),10*y_unit_vector(), 10 *z_unit_vector()),naivert.Material.DiffusionMaterial_Red_1(),reverse_normal=False)
main_scene.add_cph(Sphere(Point(70,70,10),10,15,5),naivert.Material.Glass,reverse_normal=False)
