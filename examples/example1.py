...
main_camera = naivert.Camera(Point(300,-200,300),Point(280,-180,280),10 * Vector(-1 /sqrt(6),1/sqrt(6),2/sqrt(6)),10*Vector(1/sqrt(2),1/sqrt(2),0),'main_camera.png',resolution=(100,100))
...
main_scene.add_cph(Cone(Point(70,70,0),10,80*z_unit_vector(),n=40),material=naivert.Material.DiffusionMaterial_Green_1(),reverse_normal=False)
