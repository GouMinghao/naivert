...
main_camera = naivert.Camera(Point(300,-200,300),Point(280,-180,280),10 * Vector(-1 /sqrt(6),1/sqrt(6),2/sqrt(6)),10*Vector(1/sqrt(2),1/sqrt(2),0),'main_camera.png',resolution=(1000,1000))
...
main_scene.add_cph(Parallelepiped(Point(-50,-50,0),200*x_unit_vector(),200*y_unit_vector(), -z_unit_vector()),naivert.Material.DiffusionMaterial_White_1(),reverse_normal=True)
...
main_scene.add_cph(Sphere(Point(70,30,40),20,60,20),naivert.Material.DiffusionMaterial_Blue_1(),reverse_normal=False)
main_scene.add_cph(Cone(Point(70,70,0),10,80*z_unit_vector(),n=80),material=naivert.Material.DiffusionMaterial_Green_1(),reverse_normal=False)
main_scene.add_cph(Cylinder(Point(30,70,0),15,80*z_unit_vector(),n=80),material=naivert.Material.SpecularMaterial_White_1(),reverse_normal=False)
# r = Renderer()
