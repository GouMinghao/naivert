...
main_camera = naivert.Camera(Point(400,-300,400),Point(385,-285,385),10 * Vector(-1 /sqrt(6),1/sqrt(6),2/sqrt(6)),10*Vector(1/sqrt(2),1/sqrt(2),0),'main_camera.png',resolution=(250,250))
...
main_scene.add_cph(Sphere(Point(70,90,0),20,30,15),naivert.Material.SpecularMaterial_White_1(),reverse_normal=False)
main_scene.add_cph(Sphere(Point(120,60,0),20,30,15),naivert.Material.DiffusionMaterial_White_1(),reverse_normal=False)
